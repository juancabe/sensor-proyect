...
const WRITE_WIFI_SSID_0 = '141ae9a4-f662-425f-b1b5-5bb35a9e043f';
const WRITE_WIFI_SSID_1 = '4b928144-f17a-478f-ab0e-c2c1b5ffad7a';
const WRITE_WIFI_PASS_0 = '7ccf2c21-1708-4189-b4c1-c09b3bf45f9d';
const WRITE_WIFI_PASS_1 = '52765c89-cfc0-45b6-89da-10d4d6eeb8ec';
const WRITE_WIFI_PASS_2 = '77b2f6d8-3ebc-46a6-85b3-0c01251d2430';
const WRITE_WIFI_PASS_3 = '32581ebc-3766-431d-bd2f-390ce6bee0c9';
...
function useBLE() {
    ...
    const connectToDevice = async (device: Device): Promise<DeviceRegisterInfo> => {
        ...
        try {
            ...
            registerInfo = await getDeviceRegisterInfo(device);
            if (!registerInfo) {
                console.log('No device_uuid read from characteristic');
                throw 'No device_uuid read from characteristic';
            } else {
                console.debug('device_uuid: ', registerInfo);
            }
        } catch (e) {
    ...
    const configureSensor = async (
        ...
        try {
            const encoded = base64.encodeFromByteArray(
                wifiSsidArr.slice(0, WRITE_BUFFER_LEN),
            );
            ...
            console.log(
                'WRITE_WIFI_SSID_0 wrote with: ',
                wifiSsid.slice(0, WRITE_BUFFER_LEN),
            );
        } catch (e) {
            console.error('Error occured on WRITE_WIFI_SSID_0: ', e);
            throw 'BLE Error';
        }

        try {
            const encoded = base64.encodeFromByteArray(
                wifiSsidArr.slice(WRITE_BUFFER_LEN),
            );
            await device.writeCharacteristicWithoutResponseForService(
                CFG_SERVICE,
                WRITE_WIFI_SSID_1,
            ...
            console.log(
                'WRITE_WIFI_SSID_1 wrote with: ',
                wifiSsid.slice(WRITE_BUFFER_LEN),
            );
        } catch (e) {
            console.error('Error occured on WRITE_WIFI_SSID_1: ', e);
            throw 'BLE Error';
        }
        ...
        try {
            const encoded = base64.encodeFromByteArray(
                wifiPassArr.slice(0, WRITE_BUFFER_LEN),
            );
            await device.writeCharacteristicWithoutResponseForService(
                CFG_SERVICE,
                WRITE_WIFI_PASS_0,
            ...
            console.log(
                'WRITE_WIFI_PASS_0 wrote with: ',
                wifiPass.slice(0, WRITE_BUFFER_LEN),
            );
        } catch (e) {
            console.error('Error occured on WRITE_WIFI_PASS_0: ', e);
            throw 'BLE Error';
        }

        try {
            const encoded = base64.encodeFromByteArray(
                wifiPassArr.slice(WRITE_BUFFER_LEN, WRITE_BUFFER_LEN * 2),
            );
            await device.writeCharacteristicWithoutResponseForService(
                CFG_SERVICE,
                WRITE_WIFI_PASS_1,
            ...
            console.log(
                'WRITE_WIFI_PASS_1 wrote with: ',
                wifiPass.slice(WRITE_BUFFER_LEN, WRITE_BUFFER_LEN * 2),
            );
        } catch (e) {
            console.error('Error occured on WRITE_WIFI_PASS_1: ', e);
            throw 'BLE Error';
        }

        try {
            const encoded = base64.encodeFromByteArray(
                wifiPassArr.slice(WRITE_BUFFER_LEN * 2, WRITE_BUFFER_LEN * 3),
            );
            await device.writeCharacteristicWithoutResponseForService(
                CFG_SERVICE,
                WRITE_WIFI_PASS_2,
            ...
            console.log(
                'WRITE_WIFI_PASS_2 wrote with: ',
                wifiPass.slice(WRITE_BUFFER_LEN * 2, WRITE_BUFFER_LEN * 3),
            );
        } catch (e) {
            console.error('Error occured on WRITE_WIFI_PASS_2: ', e);
            throw 'BLE Error';
        }

        try {
            const encoded = base64.encodeFromByteArray(
                wifiPassArr.slice(WRITE_BUFFER_LEN * 3, WRITE_BUFFER_LEN * 4),
            );
            await device.writeCharacteristicWithoutResponseForService(
                CFG_SERVICE,
                WRITE_WIFI_PASS_3,
            ...
            console.log(
                'WRITE_WIFI_PASS_3 wrote with: ',
                wifiPass.slice(WRITE_BUFFER_LEN * 3, WRITE_BUFFER_LEN * 4),
            );
        } catch (e) {
            console.error('Error occured on WRITE_WIFI_PASS_3: ', e);
            throw 'BLE Error';
        }

        // ALL DONE! Promise resolves
    };
